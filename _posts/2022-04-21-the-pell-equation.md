...
Both of these claims will be proved in an [appendix](/blog/the-pell-equation-appendix/) at the end of the post for completeness' sake, but these details are not the focus. What is important is that we notice the Pell Equation can be factored as the following.
...
## [Appendix](/blog/the-pell-equation-appendix/)